               ...
               std::map<std::string, Tile*> &tileAtlas)
{
    ...
    for (int pos = 0; pos < (this->width * this->height)-1; ++pos)
    {
        ...
        case TileType::VOID:
        case TileType::GRASS:
            this->tiles.push_back(tileAtlas.at("grass")->clone());
            break;
        case TileType::FOREST:
            this->tiles.push_back(tileAtlas.at("forest")->clone());
            break;
        case TileType::WATER:
            this->tiles.push_back(tileAtlas.at("water")->clone());
            break;
        case TileType::RESIDENTIAL:
            this->tiles.push_back(tileAtlas.at("residential")->clone());
            break;
        case TileType::COMMERCIAL:
            this->tiles.push_back(tileAtlas.at("commercial")->clone());
            break;
        case TileType::INDUSTRIAL:
            this->tiles.push_back(tileAtlas.at("industrial")->clone());
            break;
