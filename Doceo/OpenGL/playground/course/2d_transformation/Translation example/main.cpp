...
int main()
{
    ...
    do
    {
        ...
        if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        {
            ...
            mat3 translation = mat3(1.0f);
            //Reminder: GLM uses column major matrices and vectors. So here we are setting the last column in the matrix not the row!
            translation[2] = vec3(0,0.01,1);
