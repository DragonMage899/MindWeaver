...
int main()
{
    ...
    do
    {
        ...
        if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        {
            ...
            mat3 sheer = mat3(1.0f);
            //Reminder: GLM uses column major matrices and vectors. So here we are setting the first column in the matrix not the row!
            sheer[0] = vec3(1,0.01,0);
            model = model * sheer;
